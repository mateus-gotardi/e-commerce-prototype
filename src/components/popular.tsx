    ...
    return (
        <div className={cn(flexRow("c", "c"), "w-screen lg:mb-[-6rem] lg:mt-0 mt-12 mb-12")}>
            <div className={cn("")}>
                ...
                <div className={cn("lg:bg-accents h-fit lg:h-52 w-[95vw] rounded-b-[4rem] lg:relative top-[-10rem] lg:top-[-14rem] left-[4px] p-10 flex-wrap lg:flex-nowrap gap-7", flexRow("s", "a"))}>
