...
export default function Popular() {
    ...
    return (
        <div className={cn("w-screen flex items-center justify-center lg:mb-[-6rem] lg:mt-0 mt-12 mb-12")}>
            <div className={cn("")}>
                <h2 className={cn("lg:relative lg:top-[-18rem] lg:mb-5 lg:ml-12 w-full text-center lg:text-left", subtitle)}>Popular <span className={cn(underlined)}>Now</span></h2>
                ...
                <div className={cn("lg:bg-accents h-fit lg:h-52 w-[95vw] rounded-b-[4rem] lg:relative top-[-10rem] lg:top-[-14rem] left-[4px] p-10 flex items-start justify-around flex-wrap lg:flex-nowrap gap-7")}>
